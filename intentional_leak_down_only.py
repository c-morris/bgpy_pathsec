...
from bgp_simulator_policies import IntentionalLeak, LeakGraph, PAnn, DownOnlyPolicy, BGPsecTransitivePolicy, BGPsecPolicy, BGPsecTransitiveDownOnlyPolicy

from lib_bgp_simulator import Simulator, Graph, ROVPolicy, SubprefixHijack, BGPPolicy

graphs = [LeakGraph(
                percent_adoptions=[0, 10, 20, 50, 80, 100],
                adopt_policies=[BGPRIBSPolicy, DownOnlyPolicy, BGPsecTransitivePolicy, BGPsecTransitiveDownOnlyPolicy], 
