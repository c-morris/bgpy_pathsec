...
from bgp_simulator_policies import PTestAnn, IntentionalLeak, AccidentalLeak, NeighborHijack, OriginHijack
...
@pytest.mark.parametrize("AtkCls", [AccidentalLeak, IntentionalLeak, OriginHijack])
def test_initialize_atks(AtkCls):
    a = AtkCls()
    return True
